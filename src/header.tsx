...
function homeCont() {
    return (
        ...
        <div className='header_cont'>
            <input name="about" className="radio_header" type="radio" value="about_me"/>
                <div className='header_inactive'>
                    <svg width="26" height="28" viewBox="0 0 26 28" fill="none" xmlns="http://www.w3.org/2000/svg" stroke={inActive}>
...
function uxCont() {
    return (
        ...
        <div className='header_cont'>
            <input name="about" className="radio_header" type="radio" value="ux"/>
                <div className='header_inactive'>
                    <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg" stroke={inActive}>
...
function uiCont() {
    return (
        ...
        <div className='header_cont'>
                ...
                <p className="header_p">
                    <input name="about" className="radio_header" type="radio" value="ui"/>
                    UI
                </p>
            </div>
...
function codeCont() {
    return (
        ...
        <div className='header_cont'>
                <div className='header_inactive'>
                    <svg width="28" height="26" viewBox="0 0 28 26" fill="none" xmlns="http://www.w3.org/2000/svg" stroke={inActive}>
                ...
                <p className="header_p">
                    <input name="about" className="radio_header" type="radio" value="it"/>
                    IT
                </p>
            </div>
...
function contactCont() {
    return (
            ...
            <div className='header_cont'>
                <div className='header_inactive'>
                    <svg width="26" height="27" viewBox="0 0 26 27" fill="none" xmlns="http://www.w3.org/2000/svg" stroke={inActive}>
...
//Хук хэдер//Хук хэдер//Хук хэдер//Хук хэдер//Хук хэдер
//Хук хэдер//Хук хэдер//Хук хэдер//Хук хэдер//Хук хэдер
//Хук хэдер//Хук хэдер//Хук хэдер//Хук хэдер//Хук хэдер

const [head, setHead] = useState({
    active: null,
    objects: [{id: homeCont()}, {id: uxCont()}, {id: uiCont()}, {id: codeCont()}, {id: contactCont()}]
            ...
            <div className="header_about">
                {head.objects.map((elements, index) => (
                    <a 
                        ...
                        href=""
                        onMouseEnter={toggleHeader(index)}
                    >
                        { elements.id as any}
                    </a>
                ))}
